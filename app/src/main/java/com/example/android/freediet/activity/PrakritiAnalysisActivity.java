        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < mylist.size(); i++) {
                    ...
                    if (prakritiQues.getAnswer() != null) {
                        if (prakritiQues.getAnswer().equals("vata")){
                            ...
                            Toast.makeText(PrakritiAnalysisActivity.this, ""+vataCount, Toast.LENGTH_SHORT).show();
                        }
                ...
                if ((vataCount + kaphacount + pittacount) == 10) {
                    ...
                    Toast.makeText(getApplicationContext(), "Please give answer of all questionn", Toast.LENGTH_LONG).show();
                }
